"""
Test script for best.quant.onnx model
Tests the quantized ONNX model with valtest.zip and displays results
"""
...
OUTPUT_DIR = Path("test_outputs_quantized")
IMAGE_EXTS = {'.jpg', '.jpeg', '.png', '.bmp', '.gif', '.tif', '.tiff'}

def test_quantized_model():
    print("=" * 80)
    print("Testing best.quant.onnx (Quantized ONNX) Model")
    print("=" * 80)
    ...
    try:
        ...
        # Summary
        print("\n" + "=" * 80)
        print("RESULTS SUMMARY (best.quant.onnx)")
        print("=" * 80)
